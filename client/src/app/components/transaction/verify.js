...
class VerifyContainer extends React.Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <Dimmer active={isSubmit} inverted={true}>
                    <Loader />
                </Dimmer>
                <Container className='transferContainer'>
                    ...
                    <div className='containerBody'>
                        ...
                        <div className='containerFooter'>
                            ...
                            <Button type='submit' className='cancel-btn' onClick={(e) => this.onSubmitForm(e, false)}>Decline</Button>
                            <Button type='submit' className='accept-btn' onClick={(e) => this.onSubmitForm(e, true)}>Accept</Button>
                        </div>
